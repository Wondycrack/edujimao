...
School.create(name: 'The Japanese School', school_type: school_typpe.sample, curiculum_type: curiculum_typpe.sample, location: locat.sample[0], student_enrolment: enrol.sample, act_mean: act_meanm.sample, sat_reading: sat_read.sample, sat_math: sat_mathh.sample, province: locat.sample[1], age_range: age_rangee.sample)
School.create(name: 'The Ivy School', school_type: school_typpe.sample, curiculum_type: curiculum_typpe.sample, location: locat.sample[0], student_enrolment: enrol.sample, act_mean: act_meanm.sample, sat_reading: sat_read.sample, sat_math: sat_mathh.sample, province: locat.sample[1], age_range: age_rangee.sample)
School.create(name: 'Maple Leaf International School', school_type: school_typpe.sample, curiculum_type: curiculum_typpe.sample, location: locat.sample[0], student_enrolment: enrol.sample, act_mean: act_meanm.sample, sat_reading: sat_read.sample, sat_math: sat_mathh.sample, province: locat.sample[1], age_range: age_rangee.sample)
School.create(name: 'Beanstalk International Bilingual School', school_type: school_typpe.sample, curiculum_type: curiculum_typpe.sample, location: locat.sample[0], student_enrolment: enrol.sample, act_mean: act_meanm.sample, sat_reading: sat_read.sample, sat_math: sat_mathh.sample, province: locat.sample[1], age_range: age_rangee.sample)
School.create(name: 'The British School', school_type: school_typpe.sample, curiculum_type: curiculum_typpe.sample, location: locat.sample[0], student_enrolment: enrol.sample, act_mean: act_meanm.sample, sat_reading: sat_read.sample, sat_math: sat_mathh.sample, province: locat.sample[1], age_range: age_rangee.sample)
School.create(name: 'The Canadian International School', school_type: school_typpe.sample, curiculum_type: curiculum_typpe.sample, location: locat.sample[0], student_enrolment: enrol.sample, act_mean: act_meanm.sample, sat_reading: sat_read.sample, sat_math: sat_mathh.sample, province: locat.sample[1], age_range: age_rangee.sample)
